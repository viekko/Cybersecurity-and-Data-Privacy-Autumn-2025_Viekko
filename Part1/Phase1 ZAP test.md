...
1️⃣ Introduction
Tester(s): Veikko Name: Phase 1 – Docker & ZAP Security Testing Purpose: Tunnistaa kriittiset haavoittuvuudet rekisteröinti-, autentikointi- ja käyttöoikeusprosesseissa sekä arvioida sovelluksen suojaustaso. Scope:
...
Exclusions: Ulkoiset integraatiot, kolmannen osapuolen API:t Test approach: Gray-box (käytössä rajalliset tiedot ja testitunnukset) Test environment & dates:

Start: 23.11.2025 1100

End: 23.11.2025 1900

Environment details: Docker, Linux, MySQL, Chrome, OWASP ZAP Assumptions & constraints: Käytössä testitunnukset, 3 skannausta, ei tuotantoympäristön testaus.

2️⃣ Executive Summary
Short summary: Testauksessa havaittiin useita kriittisiä haavoittuvuuksia (SQL Injection, Path Traversal, puuttuvat CSRF-tokenit), jotka mahdollistavat tietomurrot ja käyttöoikeuksien väärinkäytön. Overall risk level: 🔴 High

Top 5 immediate actions:

Ota käyttöön salasanahashaus (bcrypt/argon2) käyttäjätietokannassa.

Korjaa SQL Injection -haavoittuvuudet parametrisoiduilla kyselyillä.

Estä Path Traversal -hyökkäykset validoimalla ja rajoittamalla tiedostopolkuja.

Lisää CSRF-tokenit kaikkiin lomakkeisiin.

Ota käyttöön Content Security Policy (CSP) XSS-hyökkäysten estämiseksi.
