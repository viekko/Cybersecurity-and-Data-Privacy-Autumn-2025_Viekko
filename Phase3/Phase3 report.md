...
Kaikki admin-näkymät palauttivat:
**“The process failed — Not Found”**
...
1. **Lukitse /api/users kokonaan adminille.**
2. **Korjaa roolitarkistukset reservation- ja user-endpointeissa.**
3. **Tee 401/403 vastaus Not Foundin sijaan.**
4. **Korjaa Admin UI – reitit puuttuvat tai väärin konfiguroitu.**
5. **Lisää yhtenäinen autorisointikerros kaikkiin endpointteihin.**
